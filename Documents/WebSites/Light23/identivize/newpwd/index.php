...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head>
    ...
    <title>Identivize New Password</title>
  </head>
      ...
      <div class="row">
        ...
        <div class="col">
          <?php
            ...
            if ( $_SESSION['new_pwd_error_message'] != '' )
            {
              echo '<div class="alert alert-danger">' . $_SESSION['new_pwd_error_message'] . '</div>';
            }
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <form action="../controller/" method="post">
            <input type="hidden" name="cmd" value="updpwd" />
            <div class="row mb-2">
              <div class="col-md-6">
                <label for="new_pwd_1" class="form-label">Password:</label>
              </div>
              <div class="col-md-6">
                <input type="password" class="form-control" id="new_pwd_1" name="new_pwd_1" maxlength="80" value="<?php echo $_SESSION['new_pwd_1']; ?>"/>
              </div>
            </div>
            <div class="row mb-3">
              <div class="col-md-6">
              ...
              <div class="col-md-6">
                <input type="password" class="form-control" id="new_pwd_2" name="new_pwd_2" maxlength="80" value="<?php echo $_SESSION['new_pwd_2']; ?>"/>
              </div>
            </div>
            <div class="row">
              ...
              <div class="col-md-6" style="text-align:left">
                <a href="../controller/?cmd=cancelupdpwd<?php echo ( $rtn != '' ? '&rtn=' . $rtn : '' ); ?>" class="btn btn-danger">Cancel</a>
              </div>
            </div>
          </form>
        </div>
